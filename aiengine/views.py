...
class KnowledgeBaseManagementView(View):
    ...
    def get(self, request: HttpRequest):
        ...
        for entry in knowledge_base_entries:
            ...
            if filename not in grouped_entries:
                grouped_entries[filename] = {
                    'entries': [],
                    'total_chunks': 0,
            ...
            grouped_entries[filename]['entries'].append(entry)
            grouped_entries[filename]['total_chunks'] += 1
                    ...
                    try:
                        ...
                        for i, result in enumerate(results):
                            knowledge_entry = KnowledgeBase.objects.create(
                                ...
                                description=description or f"Chunk {i+1} of {file.name}",
